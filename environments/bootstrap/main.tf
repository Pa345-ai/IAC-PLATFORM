...
resource "aws_s3_bucket" "tfstate" {
  bucket = "sovereign-tfstate-${var.environment}-${data.aws_caller_identity.current.account_id}"
...
resource "aws_s3_bucket" "logs" {
  bucket = "sovereign-logs-${var.environment}-${data.aws_caller_identity.current.account_id}"
...
resource "aws_cloudtrail" "bootstrap_audit" {
  name                          = "bootstrap-audit-trail"
